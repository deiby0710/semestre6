...
from bed.jerarquicas.excepciones import HomogeneityError, DuplicatedKeyError
from bed.jerarquicas.recorridos import str_pre_orden, str_in_orden, str_post_orden
