...
class Pila:
    ...
    def es_vacia(self):
        ...
        """
        return self.__superior is None
    ...
    def apilar(self, nuevo_dato):
        ...
        """
        if self.__superior and not isinstance(nuevo_dato, type(self.__superior.dato)):
            return False
        nuevo_nodo = Nodo_listaSE(nuevo_dato)
        nuevo_nodo.sig = self.__superior
        self.__superior = nuevo_nodo
        return True
    ...
    def desapilar(self):
        ...
        """
        if self.__superior:
            dato = self.__superior.dato
            self.__superior = self.__superior.sig
            return dato
        return None
    ...
    def cima(self):
        ...
        """
        return self.__superior.dato if self.__superior else None
